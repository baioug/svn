...
public class DialogUtils {
	...
	public static void showNumberDialog(Context context, View view, Map<String,String> map, String number){
		//context是在fragment类里面使用getActivity获取的 这个号函数可以获取到当前fragment对应的Activity进而获取各个控件
		view = findViewId(context);
		if (number.isEmpty()){
			tv.setVisibility(View.GONE);
			tv_result.setTextColor(Color.RED);
			tv_result.setText( "未知地区"+ context.getResources().getString(R.string.title_input_phone_nbumber));
		}
		else if (map == null)
